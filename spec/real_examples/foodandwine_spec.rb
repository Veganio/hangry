...
describe Hangry do
  context "foodandwine.com recipe" do
    before(:all) do
      @html = File.read("spec/fixtures/www.foodandwine.com.html")
    ...
    its(:description) {
      should == "The secret to this sweet, slightly tangy dish: the touch of sherry vinegar in the glaze. More Thanksgiving Side Dishes..."
    }
    its(:image_url) { should == "https://www.foodandwine.com/thmb/UISK3oYUn9mvfZy9HmX4wRF5qSM=/1471x827/smart/filters:no_upscale()/200711-xl-honey-glazed-roasted-root-vegetables-467327e8ada540df8e352d4b49e74315.jpg" }
    its(:ingredients) {
      should == [
