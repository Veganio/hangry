...
describe Hangry do
  context "rachaelray.com recipe" do
    ...
    its(:canonical_url) { should == "https://rachaelray.com/blogs/recipes/quick-chick-and-noodle-soup" }
    its(:cook_time) { should == nil }
    its(:description) {
      should == "Parsnips, which look like white carrots, but taste like sweet turnips or spicy potatoes, are best when cooked until soft to bring out their natural mellow sweetness."
    }
    ...
    its(:name) { should == "Quick Chick and Noodle Soup Recipe | Rachael Ray" }
    its(:nutrition) do
      should == {
        calories: nil,
        cholesterol: nil,
