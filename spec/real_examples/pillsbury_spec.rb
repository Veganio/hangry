...
describe Hangry do
  context "pillsbury.com recipe" do
    ...
    its(:description) { should == "Enjoy these cheesy pepperoni hand pies made using Pillsbury™ Grands!™ Original Crescent Rolls or Pillsbury™ Grands!™ Butter Flake Crescent Rolls–a delicious dinner that’s ready in 35 minutes." }
